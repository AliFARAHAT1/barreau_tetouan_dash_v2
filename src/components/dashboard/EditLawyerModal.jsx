  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="sticky top-0 bg-[#0969b3] text-white px-6 py-4 flex items-center justify-between rounded-t-2xl z-10">
          ...
          <div className="p-6 overflow-y-auto flex-1">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label className="block text-lg font-bold text-[#0969b3] mb-3">
                  الصورة الشخصية
                </label>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <label className="cursor-pointer px-6 py-3 bg-[#0969b3] text-white rounded-lg hover:bg-[#b8954a] transition-colors flex items-center gap-2 font-medium">
                    <Upload size={20} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-[#0969b3] mb-2">
                    الاسم الكامل (عربي) *
                  </label>
                  <input
                    type="text"
                ...
                {/* <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-lg focus:outline-none focus:border-[#CAAA5C] transition-colors cursor-pointer ${
                      formData.city === "" ? "text-gray-400" : "text-[#0969b3]"
                    }`}
                  >
                    <option value="" disabled hidden>
                      اختر المدينة  
                    </option>
                    <option value="تطوان" className="text-[#0969b3]">تطوان</option>
                    <option value="أصيلة" className="text-[#0969b3]">أصيلة</option>
                    <option value="العرائش" className="text-[#0969b3]">العرائش</option>
                    <option value="القصر الكبير" className="text-[#0969b3]">القصر الكبير</option>
                  </select>
                </div> */}
                ...
                {/* {isUserOffice && (
                  <div>
                      ...
                      <select
                        ...
                        required
                        className={`w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-lg focus:outline-none focus:border-[#CAAA5C] transition-colors cursor-pointer ${
                          formData.typeOfPractice === "" ? "text-gray-400" : "text-[#0969b3]"
                        }`}
                      >
                        <option value="" disabled hidden>
                          اختر كيفية الممارسة
                        </option>
                        <option value="شريك في الشركة المدنية" className="text-[#0969b3]">شريك في الشركة المدنية</option>
                        <option value="صاحب المكتب" className="text-[#0969b3]">صاحب المكتب</option>
                        <option value="شريك" className="text-[#0969b3]">شريك</option>
                        <option value="مساكن" className="text-[#0969b3]">مساكن</option>
                        <option value="مساعد" className="text-[#0969b3]">مساعد</option>
                      </select>
                  </div>
                )} */}
              ...
              <div className="flex items-center justify-end gap-4 mt-8 pt-6 border-t-2 border-slate-200">
                <button
                  ...
                  className="px-6 py-3 bg-slate-100 text-[#0969b3] rounded-lg hover:bg-slate-200 transition-colors font-medium disabled:opacity-50"
                >
                  إلغاء
                </button>
                <button
                  type="submit"
                  disabled={uploading || updating}
                  className="px-6 py-3 bg-green-600 text-white rounded-lg hover:from-[#b8954a] hover:to-[#a68440] transition-all font-medium disabled:opacity-50 flex items-center gap-2"
                >
